...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour mus have more or equal than 10 chars']
      //validate: [validator.isAlpha, 'Tour name must only contain characters']
    },
    slug: String,
    duration: {
      type: Number,
      required: [true, 'A tour model must have a duration']
    },
    maxGroupSize: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: function(val) {
        // this only points to current doc on new documment creation
        return val < this.price;
      },
      message: 'Discount price ({VALUE}) should be lower thna regular price'
    },
    summary: {
      type: String,
      trim: true,
